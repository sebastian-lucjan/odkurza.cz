...
export default function EquipmentWroclaw() {
  const {
        ...
        <div className="bg-gray-50 pt-6 px-6">
          <div className="flex justify-center pb-6 flex flex-col">
            ...
            <Menu as="div" className="relative text-left">
              <div className="mt-6">
                <Menu.Button className="inline-flex justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-gray-100">
                  ...
                  <div className="relative p-4 w-full">
                      ...
                      <div className="w-[80%]">
                        ...
                        <div className="flex justify-between">
                          <div className="flex font-bold text-black">
                            <p className="underline underline-offset-2 decoration-2 decoration-sky-300">Pt. - Nd. (weekend):</p>
                      ...
                      <div className="w-[80%]">
                        ...
                        <div className="flex justify-between border-t border-gray-100">
                          <div className="flex font-bold text-black w-1/5">
                            <p className="underline underline-offset-2 decoration-2 decoration-sky-300">{cleaner[600]}ml</p>
                            <p className="text-xl">*</p>
                          </div>
                          <ul className="w-3/5">
                            <li>- Kanapa 4os.</li>
                    ...
                    <div className="flex mb-4 border-b-4 pb-2 border-gray-100">
                      ...
                      <div className="w-[80%]">
                        ...
                        <div className="flex justify-between">
                          <div className="flex font-bold text-black">
                            <p className="underline underline-offset-2 decoration-2 decoration-sky-300">Odbiór osobisty:</p>
                            <p className="text-xl">*</p>
                          </div>
                    ...
                    <div className="flex">
                      <div className="flex font-bold  mr-4 w-1/4">
                        <p className="underline underline-offset-[-4px] decoration-4 decoration-sky-300 text-4xl text-black">*</p>
                      </div>
                      <div className="w-4/5">
          ...
          <div className="my-5 sm:mt-8 sm:flex sm:justify-center">
            <div className="rounded-md">
              <Link href="/kontakt">
                <a className="flex w-full items-center justify-center rounded-md bg-gradient-to-b from-sky-200 to-sky-400 color-black px-8 py-3 text-base font-medium text-black hover:text-white font-black hover:from-green-600 hover:to-green-600 md:py-4 md:px-10 md:text-lg shadow-lg hover:brightness-125">
